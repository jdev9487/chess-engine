...
{
    public static class NoDueToNotOpen
    {
        public static EnPassantTestModel WhiteCapturesToTheRight =>
            new()
            {
                ...
                PieceToBeCaptured = new Pawn
                    { Colour = Colour.Black, Position = Square.At(File.F, Rank.Five), OpenToEnPassant = false }
            };
        ...
        public static EnPassantTestModel WhiteCapturesToTheLeft =>
            new()
            {
                ...
                PieceToBeCaptured = new Pawn
                    { Colour = Colour.Black, Position = Square.At(File.D, Rank.Five), OpenToEnPassant = false }
            };
        ...
        public static EnPassantTestModel BlackCapturesToTheRight =>
            new()
            {
                ...
                PieceToBeCaptured = new Pawn
                    { Colour = Colour.White, Position = Square.At(File.F, Rank.Four), OpenToEnPassant = false }
            };
        ...
        public static EnPassantTestModel BlackCapturesToTheLeft =>
            new()
            {
                ...
                PieceToBeCaptured = new Pawn
                    { Colour = Colour.White, Position = Square.At(File.D, Rank.Four), OpenToEnPassant = false }
            };
    }
}